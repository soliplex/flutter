...
// node_modules/@pydantic/monty-wasm32-wasi/monty.wasi-browser.js
var __wasi = new WASI({
  version: "preview1"
});
var __wasmUrl = new URL("./monty.wasm32-wasi.wasm", import.meta.url).href;
...
var monty_wasi_browser_default = __napiModule.exports;
var Monty = __napiModule.exports.Monty;
var MontyComplete = __napiModule.exports.MontyComplete;
var MontyException = __napiModule.exports.MontyException;
var JsMontyException = __napiModule.exports.JsMontyException;
var MontyRepl = __napiModule.exports.MontyRepl;
var MontySnapshot = __napiModule.exports.MontySnapshot;
var MontyTypingError = __napiModule.exports.MontyTypingError;

// src/worker_src.js
var activeSnapshot = null;
var activeMonty = null;
var callIdCounter = 0;
self.postMessage({
  type: "ready",
...
function translateLimits(limits) {
  ...
  if (limits.timeout_ms != null) {
    opts.maxDurationSecs = limits.timeout_ms / 1e3;
  }
...
function toSerializable(val, seen) {
  ...
  if (val instanceof Map || typeof val.entries === "function" && typeof val.size === "number" && typeof val.get === "function") {
    const obj2 = {};
    for (const [k, v] of val.entries()) {
      obj2[String(k)] = toSerializable(v, seen);
    }
    return obj2;
  }
  if (val instanceof Set || typeof val.has === "function" && typeof val.size === "number" && typeof val.get === "undefined") {
    const arr = [];
    for (const v of val) {
