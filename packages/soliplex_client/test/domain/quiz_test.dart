  ...
  group('QuizAnswerResult', () {
    ...
    group('equality', () {
      test('equal based on all fields', () {
        const result1 = QuizAnswerResult(isCorrect: true, expectedAnswer: 'A');
        const result2 = QuizAnswerResult(isCorrect: true, expectedAnswer: 'A');
        const result3 = QuizAnswerResult(isCorrect: false, expectedAnswer: 'A');
        const result4 = QuizAnswerResult(isCorrect: true, expectedAnswer: 'B');
      ...
      test('identical returns true', () {
        const result = QuizAnswerResult(isCorrect: true, expectedAnswer: 'A');
