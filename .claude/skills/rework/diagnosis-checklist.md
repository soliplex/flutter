...
If the file defines types, encodes business rules, manages state
transitions, or transforms data, those responsibilities belong
elsewhere — regardless of file length.
...
No size threshold — see CLAUDE.md.
